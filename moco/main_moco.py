...
model_names.append("efficientb5")
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if args.distributed:
        ...
        init_method = 'tcp://'+args.dist_url+':4567'
    ...
    elif args.arch in "efficientb5":
        print("=> Effib5: creating model '{}'".format(args.arch))
        ...
        if not args.multiprocessing_distributed or (args.multiprocessing_distributed
            ...
            save_checkpoint({
                ...
                'optimizer' : optimizer.state_dict(),
                            ...
                            pre_filename='./ckpt/checkpoint_{:04d}.pth.tar'.format(epoch-1))
