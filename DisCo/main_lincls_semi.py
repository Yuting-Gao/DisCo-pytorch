...
parser.add_argument('--label', default=1.0, type=int, choices=[1, 10],
                    help='1% or 10% label dataset used to finetuned.')
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    # Data loading code
    #if args.label == 1:
    #    train_data = '/youtu-reid/jiaxzhuang/data/imagenet_1_fraction'
    #elif args.label == 10:
    #    train_data = '/youtu-reid/jiaxzhuang/data/imagenet_10_fraction'
    #else:
    #    print("no availabel dataset.")
    #    sys.exit(-1)
