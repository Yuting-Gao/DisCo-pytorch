...
class MoCo(nn.Module):
    ...
    def __init__(self, base_encoder, dim=128, K=65536, m=0.999, T=0.07, mlp=False,
                 arch='resnet50', teacher_path=None):
        """
        ...
        self.teacher_encoder_q = resnet50(num_classes=dim)
        self.teacher_encoder_k = resnet50(num_classes=dim)
        ...
        #if teacher_path:
        #    print('load teacher dict from', teacher_path)
        ...
        #            state_dict[k[len("module.encoder_q."):]] = state_dict[k]
                #if k.startswith('module.teacher_encoder_q'):
                    # remove prefix
                #    state_dict[k[len("module.teacher_encoder_q."):]] = state_dict[k]
                # delete renamed or unused k
        #        del state_dict[k]
        #    self.teacher_encoder_q.load_state_dict(state_dict, strict=True)
    ...
    def forward(self, im_q, im_k):
        ...
        with torch.no_grad():  # no gradient to keys
            ...
            teacher_q = self.teacher_encoder_q(im_q)
            teacehr_q = nn.functional.normalize(teacher_q, dim=1)
        ...
        return logits, labels, teacher_q, q
